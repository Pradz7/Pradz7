...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=500&size=22&pause=1000&color=00D8FF&center=true&vCenter=true&width=650&lines=Building+AI-powered+web+applications;Exploring+Machine+Learning+and+AI;Turning+ideas+into+useful+products)](https://git.io/typing-svg)
...
I'm **Made M. Pradnya P.**, a developer interested in building useful applications powered by **AI**.

I enjoy creating projects that combine clean user experience, practical features, and intelligent systems.  
Right now, I'm focusing on web development, AI integration, and building products that solve real problems.

- 🔭 Currently working on **web and mobile development**
- 🌱 Learning more about **Flutter, Next.js, AI, and UI/UX**
- 💡 Interested in creating apps that are simple, fast, and user-friendly
- 🎯 Goal: Become a strong full-stack developer and build products people enjoy using
